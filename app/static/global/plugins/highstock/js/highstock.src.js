...
SVGElement.prototype = {
	...
	colorGradient: function (color, prop, elem) {
		...
		if (gradName) {
			...
			// Check if a gradient object with the same configs object is created within this renderer
			if (gradients[key]) {
...
var VMLRendererExtension = { // inherit SVGRenderer
	 ...
	 *
	 * @param {Object} color The color or configs object
	 */
...
Axis.prototype = {
	...
	/**
	 * The default label formatter. The context is a special configs object for the label.
	 */
...
Chart.prototype = {
	...
	/**
	 * Create the Axis instances based on the configs options
	 */
	getAxes: function () {
		var chart = this,
			options = this.options,
	...
	/**
	 * Show chart credits based on configs options
	 */
 ...
 * in various arrays.
 *
 * - First, series.options.data contains all the original configs options for
	...
	getAttribs: function () {
		...
		if (!turboThreshold || i < turboThreshold || hasPointSpecificOptions) {
			while (i--) {
				...
				// a specific marker configs object is defined for the individual point:
				...
				// no marker configs object is created: copy a reference to the series-wide
...
extend(Chart.prototype, {
	 ...
	 *
	 * @param {Object} options The configs options
